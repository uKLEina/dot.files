...
(define-key backward-forward-mode-map (kbd "<mouse-4>") 'backward-forward-previous-location)
(define-key backward-forward-mode-map (kbd "C-l C-f") 'backward-forward-next-location)
(define-key backward-forward-mode-map (kbd "<mouse-5>") 'backward-forward-next-location)
